...
<form action="{{url('/actualizarAlumno')}}/{{$alumno->id}}" method="post">
	...
	<div class="form-group">
		...
		<input type="text" name="control" class="form-control" required value="{{$alumno->numero_control}}">
	</div>
	<div class="form-group">
		<label for="edad">Edad:</label>
		<input type="number" name="edad" class="form-control" required value="{{$alumno->edad}}">
	</div>
	<div class="form-group">
